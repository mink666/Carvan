    ...
    public function run(): void
    {
        $brands = [
            ...
            [
                ...
                'is_active' => false, // Đặt là false cho Volvo
            ]
        ];

        foreach ($brands as $brandData) {
            // Dòng này sẽ tìm Brand theo 'name' hoặc tạo mới nếu chưa có.
            // Nó sẽ cập nhật/điền tất cả các trường trong $brandData, bao gồm 'is_active'.
