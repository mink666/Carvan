    ...
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-lg font-bold">All Brand:
        ...
        <div class="flex items-center gap-2">
            ...
            <!-- Search Input -->
            <form method="GET" action="{{ route('Admin.BrandMgr') }}"
                x-show="open"
    ...
    <table class="w-full text-sm text-left text-gray-700">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td class="p-3">
                <img src="{{ asset('' . $brand->logo) }}" alt="{{ $brand->name }}" class="w-30 h-12 object-contain mx-auto">
            </td>
            <td class="p-3">
...
$(document).ready(function () {
    ...
    function renderPagination() {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            $btn.click(() => { currentPage = i; update(); });
        ...
        $next.click(() => { if (currentPage < pageCount) { currentPage++; update(); } });
