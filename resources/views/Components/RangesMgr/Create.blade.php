<div class="max-w-8xl w-full mx-auto bg-white shadow-xl rounded-xl overflow-hidden flex">
    ...
    <form action="{{ route('Admin.RangesMgr.store') }}" method="POST" enctype="multipart/form-data" class="flex w-full">
        @csrf
        <div class="w-1/2 p-6 flex flex-col">
            <h2 class="text-lg font-semibold text-gray-700 mb-4">Create Range</h2>
        ...
        <div class="w-1/2 p-6 flex flex-col">
            ...
            <div class="space-y-4 flex-grow">
                ...
                <div>
                    ...
                    <input type="text" name="id" value="{{$nextId}}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black">
                </div>
                <!-- Range name -->
                <div>
